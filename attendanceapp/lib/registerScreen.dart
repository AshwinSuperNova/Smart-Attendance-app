    ...
    return Scaffold(
      ...
      body: Center(
          child: Form(
              ...
              child: ListView(
                shrinkWrap: true,
                padding: EdgeInsets.only(top: 16.0, left: 15.0, right: 15.0),
                children: <Widget>[
                  Padding(
                    padding: EdgeInsets.all(5.0),
                    child: Text(
                      'Register',
                      style: TextStyle(fontSize: 36.0, color: Colors.black,fontFamily: "NexaBold"),
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        hintText: 'Email',
                        contentPadding:
                        EdgeInsets.fromLTRB(30.0, 30.0, 20.0, 10.0),
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text('Sign Up'.toUpperCase(),
                          style: TextStyle(color: Colors.white,fontFamily: "NexaBold",fontSize: 20.0)),
                    ),
                  ),
                  Padding(
                      ...
                      child: ElevatedButton(
                        child: Text(
                          'Cancel',
                          style: TextStyle(color: Colors.black,fontFamily: "NexaBold",fontSize: 20.0),
